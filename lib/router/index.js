...
Router.prototype.load = function(async_data, cb) {
...
Router.prototype.reset = function() {
  ...
  _.each(this._privateRouter.routes, function(routes, httpMethod) {
    ...
    _.each(routesToUnbind, self.unbind.bind(self));
  });
...
Router.prototype.flush = function(routes) {
  ...
  _.forEach(this.explicitRoutes, function(target, path) {
    self.bind(path, target);
  });
